...
.PHONY: build build-darwin-arm64 build-darwin-amd64 build-linux-amd64 all clean install
...
cross-darwin-arm64:
	fyne-cross darwin -arch arm64 -output $(APP_NAME)

cross-darwin-amd64:
	fyne-cross darwin -arch amd64 -output $(APP_NAME)

cross-linux-amd64:
	fyne-cross linux -arch amd64 -output $(APP_NAME)
